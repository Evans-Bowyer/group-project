...
# probably should switch from QWidget object to QGuiApplication or QWindow object
class MyWidget(wdgt.QWidget):
    def __init__(self):
        ...
        self.chem_menu.addItems(pollutants)
        ...
        # TODO create object to display data to
        # QtDataVisualization module ?
